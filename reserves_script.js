...
const productGroupMap = {
    ...
    "8.5cm Straw 21": 3, "8.5cm Straw 22": 3, "8.5cm Straw 23": 3, "8.5cm Straw 24": 3,
    ...
    "1L Veg 20": 12, "1L Veg 22": 12, "1L Veg 24": 12,
    "Autumn Strip": 13,
    "Wild flower 12": 14,
    "Mixed Pot 18": 15,
};
...
const filterCentre = () => {
    ...
    if (filteredData.length > 0) {
        ...
        productHeaders.forEach((product) => {
            ...
            // Create cells for product name, reserves, input, buttons, and notes
            ...
            const halfValue = productGroupValues[groupNumber]?.half; // Don't provide a default
            ...
            // Only create the Half button if halfValue is defined
            ...
            notesField.style.width = '150px';
            notesField.style.height = '40px';
            notesCell.appendChild(notesField);
        ...
        noDataCell.colSpan = 5; // Adjust the colspan for the extra column
